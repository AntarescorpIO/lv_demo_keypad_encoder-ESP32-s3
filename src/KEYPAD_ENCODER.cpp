 ...
 * 
 * a la practica de keypad_encoder le hace falta diseñarle un teclado para poder ingresar datos a la rutina
 ******************************************************************************/
...
/**********************
 *      codigo para ejecutar la comunicacion serial hacia la pc via usb
 **********************/
...
void setup()
{
 ...
 /*para la siguiente  tarea se tienen que modificar los archivos  lv_conf.h */   
    //lv_demo_widgets();

    /*para la siguiente  tarea se tienen que modificar los archivos  lv_demo_conf.h  y lv_conf.h */     
